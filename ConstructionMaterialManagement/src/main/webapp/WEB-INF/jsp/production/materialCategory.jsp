...
$(document).ready(function () {
	$("#materialcategoryTableContainer").jsGrid({
	       width: "100%",
	       filtering: true,
	       editing: true,
	       sorting: true,
	       ...
	       controller: {
	                   ...
	                   data:filter,
	                     success: function (data) {
	                     	var data1 = $.grep(data, function(data) {
	                            return (!filter.materialCategoryName || (data.materialCategoryName+'').toUpperCase().indexOf(filter.materialCategoryName.toUpperCase()) > -1)
	                       });   
                   	d.resolve(data1);
	                   },
	                   error: function(e) {
	         ...
	         insertItem: function(insertingClient) {
	    	       $.ajax({
	    	                   type: 'POST',
	    	                   url: '/materialcategory/saveMaterialcategory',
	    	                   dataType: "json",
	    	   ...
	    	   deleteItem: function(deletingClient) {
	    	   	$.ajax({
	    	                   type: 'DELETE',
	    	                   url: '/materialcategory/deleteMaterialcategory/'+deletingClient.materialCategoryId,
	    	                   dataType: "json",
	    	                   contentType: 'application/json',
	    	                   success: function (data) {
	       ...
	       fields: [
	    	       { name: "materialCategoryId", type: "hidden",  width:75, title: "Material Category Id"},
		           { name: "materialCategoryName", type: "text",  width:75, title: "Material Category Name"},
		           { type: "control" } 
		       ]
		       });
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div id="materialcategoryTableContainer"></div>
				</div>
				</div>
                </div>
              </div>
