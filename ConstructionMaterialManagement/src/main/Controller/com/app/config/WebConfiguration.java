 ...
 * @EnableSwagger2
 * 
 * @EnableAutoConfiguration public class WebConfiguration implements
 * WebMvcConfigurer {
 * 
 * 
 ...
 * metaData() { return new ApiInfoBuilder() .title("benefits-feature-members")
 * .description("Core member service") .version("1.0.0")
